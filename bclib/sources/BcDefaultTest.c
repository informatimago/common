...
main()
{
        static BcDefault_T vector[] = {
            {"NXFont",              "Helvetica"},
            {"NXFontSize",          "12.0"},
            {"Nom avec: \\<-ici",   "DonnÝe avec tabulation: <  >"},
            {"DonnÝe avec return",  "Le retour est lÕ: <\n> nouvelle ligne"},
            {NIL,               NIL}
        };
        INT32           i;
        const char*     value;
    ...
    BcDefault_Set(OWNER,"Nouveaux default","Le grand-pÜre de ma "
                    "grand-mÜre et le pÜre de la mÜre de mon grand-frÞre.");
